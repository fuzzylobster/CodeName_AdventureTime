    ...
    return (
        <View style={[styles.bar, styles.badgeContainer]}>
            <View style={[styles.barItem, styles.barSeparator]}>
                <Text style={styles.barTop}>{this.props.adventures.length}</Text>{/** Adventures completed*/}
                <Text style={styles.barBottom}>Adventures completed</Text>
            </View>
            <View style={[styles.barItem, styles.barSeparator]}>
                <Text style={styles.barTop}>{this.milesTrekked()}</Text>{/** Miles trekked*/}
                <Text style={styles.barBottom}>Miles Trekked</Text>
            </View>
            <View style={[styles.barItem, styles.barSeparator]}>
                <Text style={styles.barTop}>{this.cities()}</Text>{/** Cities Conquered*/}
                <Text style={styles.barBottom}>Cities Conquered</Text>
            </View>
            <View style={styles.barItem}>
                <Text style={styles.barTop}>{this.badges()}</Text>{/** Badges Completed*/}
